...
<body>
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="category.html">معلومات المستخدم</a>
					</nav>
				</div>
			</div>
		</div>
    ...
    <!-- User Profile Area -->
    <section class="user-profile-area section_gap_bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="user-profile-info">
                        <div class="user-avatar">
                            <img width="100%" src="img/avatar.jpg" alt="User Avatar">
                        </div>
                        <h4>يوسف جرادات </h4>
                        <p>مشترك من2007</p>
                    ...
                    <div class="user-profile-details">
                        ...
                        <form class="user-profile-form">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="username" value="يوسف جرادات" readonly>
                            </div>
                            <div class="form-group">
                                <label for="email">البريد الإليكتروني</label>
                                <input type="email" class="form-control" id="email" value="Yousef-Jaradat@gmail.com" readonly>
                            </div>
                            <div class="form-group">
                                <label for="birthdate">تاريخ الميلاد</label>
                                <input type="text" class="form-control" id="birthdate" value="2000/4/29" readonly>
                            </div>
                            <!-- Add more user details fields here -->
                            <button type="submit" class="primary-btn">تحديث المعلومات</button>
                        </form>
                    </div>
                </div>
            </div>
